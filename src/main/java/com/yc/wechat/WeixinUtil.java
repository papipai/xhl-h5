...
public class WeixinUtil {
    ...
    * @throws 说明发生此异常的条件
     */
    public static Map<String, String> getWxConfig(String requestUrl) {
        Map<String, String> ret = new HashMap<String, String>();
      
        String appId = "wx251814c46ac42181"; // 必填，公众号的唯一标识
        String secret = "2ac457d1bd6cf0996c8f726b90ff5bc7";
